 ...
 * dispatched immediately. This is the event boundary that a Kafka producer would replace: same
 * {@link NotificationRequest} payload, different transport.
 */
@Slf4j
public class NotificationPublisher {
    ...
    public NotificationPublisher(NotificationClient client, Executor executor) {
        this.client = client;
